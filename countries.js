const countries = [
  ...
  // Creating all the outer elements
  const outerDiv = document.createElement('div'); //Largest div, append to body
  const headerDiv = document.createElement('div'); //Top inner div, contains headings append to outerDiv
  const innerDiv = document.createElement('div'); //lower inner div, contains countryDiv append to outerDiv
  
  const heading = document.createElement('h1'); //Main heading append to headerDiv
  const headingPara = document.createElement('p');

   // All outer appendings
  document.body.appendChild(outerDiv);
  outerDiv.appendChild(headerDiv);
  outerDiv.appendChild(innerDiv);
  headerDiv.appendChild(heading);
  headerDiv.appendChild(headingPara);

  //Adding classes outer elements

  outerDiv.setAttribute('class', 'outerdiv');
  headerDiv.setAttribute('class', 'headerdiv');
  innerDiv.setAttribute('class', 'innerdiv');
  heading.setAttribute('class', 'heading');
  headingPara.setAttribute('class', 'headingpara');


  let count = countries.length;

    //Inputting information to outer elements
  heading.textContent = 'The countries of the world.'; // Text of the heading
  headingPara.textContent = `There are ${count} countries in the world.`; // text of heading paragraph
    ...
    for  (const country of countries) {
        ...
        let {
            name, capital, population, currency,flag 
        } = country;
        let count = countries.length;
        console.log(count)
        ...
        //Adding classes to inner elements

        countryName.setAttribute('class', 'countryname');
        countryCapital.setAttribute('class', 'countrycapital');
        countryPopulation.setAttribute('class', 'countrypopulation');
        countryCurrency.setAttribute('class', 'countrycurrency');
